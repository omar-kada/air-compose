...
describe('formatElapsed', () => {
  it('returns "-" when either date is invalid', () => {
    ...
    expect(formatElapsed('2024-01-15T00:00:00Z')).toBe('-');
  });

  it('formats a 5-second span as "5s"', () => {
    expect(formatElapsed('2024-01-15T00:00:00Z', '2024-01-15T00:00:05Z')).toBe('5s');
  });

  it('formats a 2-minute span as "2m"', () => {
    expect(formatElapsed('2024-01-15T00:00:00Z', '2024-01-15T00:02:00Z')).toBe('2m');
  });
});
...
describe('humanizeDuration', () => {
  it('computes the relative duration between two dates', () => {
    expect(humanizeDuration('2024-01-15T00:00:00Z', '2024-01-15T00:00:05Z')).toBe('in 5 seconds');
  });
});
